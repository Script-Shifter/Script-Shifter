<div style="background: linear-gradient(135deg, #6a11cb, #2575fc); padding: 50px; border-radius: 20px; max-width: 950px; margin: auto; color: white; font-family: 'Arial', sans-serif;">
